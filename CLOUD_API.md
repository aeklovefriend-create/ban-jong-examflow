...
เว็บหลักยังเก็บ Draft ในเครื่องเพื่อให้ทำงานต่อได้เมื่อสัญญาณไม่เสถียร แต่เมื่อกดส่ง ฝั่งเว็บจะส่ง metadata และไฟล์ขนาดไม่เกิน 9 MB ต่อไฟล์ไปยัง Cloud API ทำให้หัวหน้าวิชาการเห็นรายการจากทุกเครื่องหลังอัปเดตข้อมูล
